    ...
    return (
      <div style={{ fontFamily: 'sans-serif', minHeight: '100vh', background: '#F4F6F9', display: 'flex' }}>
        ...
        <div style={{ width: '220px', background: '#fff', borderRight: '1px solid #E0E0E0', padding: '24px 0', flexShrink: 0 }}>
          ...
          <div style={{ padding: '8px 20px', fontSize: '14px', color: '#185FA5', fontWeight: '500', background: '#EEF4FB', borderRight: '3px solid #185FA5' }}>📋 Ordens de Serviço</div>
        ...
        <div style={{ flex: 1, padding: '32px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            ...
            <button style={{ background: '#185FA5', color: '#fff', border: 'none', padding: '10px 20px', borderRadius: '8px', fontSize: '14px', cursor: 'pointer' }}>
              + Nova OS
            </button>
          </div>
