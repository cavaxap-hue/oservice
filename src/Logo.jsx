...
function Logo({ modo = 'dark', tamanho = 1, comSlogan = true }) {
  const azul = modo === 'dark' ? '#FFC266' : '#C9861F'
  const barra = modo === 'dark' ? '#F2A93B' : '#C9861F'
  ...
  return (
    <svg width={w} height={h} viewBox={comSlogan ? '0 0 360 90' : '0 0 360 76'} xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="11" y="14" width="3.5" height="62" rx="1.75" fill="#FFC266" opacity={modo === 'dark' ? 0.5 : 0.7} />
      ...
      <text x="56" y="53" textAnchor="middle" fontFamily="sans-serif" fontSize="24" fontWeight="700" fill="#1B1305">S</text>
